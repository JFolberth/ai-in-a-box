...
- **Backend Build**: .NET 10 build, testing, and publish artifacts  
...
- **Local**: Manual setup with Node.js, **.NET 10 SDK**, and Azure CLI

> **⚠️ Important**: The backend requires **.NET 10 SDK** specifically. The project targets `net10.0` framework and will not build with older .NET versions.
