...
This guide covers all configuration aspects of the AI Foundry SPA project, including environment variables, deployment parameters, and service configurations.
...
export const environment = {
  production: false,
  apiBaseUrl: 'http://localhost:7071', // Local Function App
...
These are set via Bicep deployment parameters:

| Variable | Description | Example |
|----------|-------------|---------|
| `AI_FOUNDRY_ENDPOINT` | AI Foundry service endpoint URL | `https://your-service.cognitiveservices.azure.com/` |
| `AI_FOUNDRY_DEPLOYMENT` | Deployment/model name | `gpt-4o-mini` |
| `AI_FOUNDRY_AGENT_NAME` | Agent identifier | `AI in A Box` |
| `APPLICATIONINSIGHTS_CONNECTION_STRING` | Application Insights connection | Auto-generated by Bicep |
...
param aiFoundryDeployment = 'gpt-4o-mini'
...
Examples:
- Static Web App: `stapp-ai-foundry-spa-frontend-dev-abc123def` (where `abc123def` is generated by uniqueString())
- Function App: `func-ai-foundry-spa-backend-dev-xyz789ghi`
...
The Function App uses **system-assigned managed identity** with minimal required permissions:

- **Azure AI Developer** role scoped to the AI Foundry resource
- **Storage Blob Data Contributor** for Function App storage needs
