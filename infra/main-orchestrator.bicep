...
output frontendStorageAccountName string = frontendInfrastructure.outputs.storageAccountName
...
output frontendEnvironmentVariables object = {
  ...
  VITE_STORAGE_ACCOUNT_NAME: frontendInfrastructure.outputs.storageAccountName
